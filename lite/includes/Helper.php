...
class Helper {
	...
	public static function get_plugin_admin_screens() {
		...
		$prefix = sanitize_title( __( 'Logify', 'logify' ) );

		$screens = [
			'toplevel_page_logify',
			"{$prefix}_page_logify-activity-logs",
		];

		return apply_filters( 'kaizencoders_logify_admin_screens', $screens );
	}
